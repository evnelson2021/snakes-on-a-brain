-- This module will ceate tables for Species, Snakes, and Owners
-- This module will add the data into each appropriate table using INSERT INTO
-- This module will assist in querying for the correct information to pass into the functions within each respective view (owner/snake/species_requests)
